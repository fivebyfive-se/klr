...
class SimulatedColor {
  SimulatedColor(this.color);

  final Color color;
  
  Color get protanomaly => simulate(ColorBlindnessType.protanomaly);
  Color get deuteranomaly => simulate(ColorBlindnessType.deuteranomaly);
  Color get tritanomaly => simulate(ColorBlindnessType.tritanomaly);
  Color get protanopia => simulate(ColorBlindnessType.protanopia);
  Color get deuteranopia => simulate(ColorBlindnessType.deuteranopia);
  Color get tritanopia => simulate(ColorBlindnessType.tritanopia);
  Color get achromatopsia => simulate(ColorBlindnessType.achromatopsia);
  Color get achromatomaly => simulate(ColorBlindnessType.achromatomaly);

  @protected
  Map<ColorBlindnessType,Color> _simulations = <ColorBlindnessType,Color>{};
  
  Color simulate(ColorBlindnessType type) {
    if (!_simulations.containsKey(type)) {
      _simulations[type] = colorBlindness(color, type);
    }
    return _simulations[type];
  }
}
...
String colorBlindnessTypeToString(ColorBlindnessType type)
  => type.toString().replaceAll("ColorBlindnessType.", "");
